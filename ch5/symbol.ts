...
export abstract class InternalSymbol {
	name: string;
...
export class FunctionSymbol extends InternalSymbol {
	vars: VarSymbol[] = []; //本地变量的列表。参数也算本地变量。

	opStackSize = 10; //操作数栈的大小
...
export class VarSymbol extends InternalSymbol {
...
/////////////////////////////////////////////////////////////////////////
//一些系统内置的符号
export const FUN_println = new FunctionSymbol(
	'println',
	new FunctionType(SysTypes.Void, [SysTypes.String]),
	[new VarSymbol('a', SysTypes.String)]
);
export const FUN_tick = new FunctionSymbol(
	'tick',
	new FunctionType(SysTypes.Integer, []),
	[]
);
export const FUN_integer_to_string = new FunctionSymbol(
	'integer_to_string',
...
const FUN_string_create_by_str = new FunctionSymbol(
	'string_create_by_str',
	new FunctionType(SysTypes.String, [SysTypes.String]),
	[new VarSymbol('a', SysTypes.String)]
);
const FUN_string_concat = new FunctionSymbol(
	'string_concat',
...
export const intrinsics: Map<string, FunctionSymbol> = new Map([
...
export class SymbolDumper extends SymbolVisitor {
	visit(sym: InternalSymbol, additional: any) {
